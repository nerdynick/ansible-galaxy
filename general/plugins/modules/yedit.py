...
# Originally from https://github.com/kwoodson/ansible-role-yedit
# Due to Ansible limitation (Collections can't depend on Standalone Roles, See https://github.com/ansible/ansible/issues/76030 and https://stackoverflow.com/questions/69508170/ansible-role-dependency-handling-for-collections)
# this module has had to be direct copied here instead of linked via dependencies. 
